...
namespace Dapper.SqlGenerator.Tests
{
    ...
    public class SqlNamingTests
    {
        ...
        public void TestInsertPostgres()
        {
            ...
            Assert.AreEqual("INSERT INTO \"test_products\" (\"Type\",\"content\",\"enum\",\"maybedate\",\"date\",\"maybeguid\",\"guid\",\"last\") VALUES (@Kind,CAST(@Content AS json),@Enum,@MaybeDate,@Date,@MaybeGuid,@Guid,@Last)", insert);
        }
    }
}