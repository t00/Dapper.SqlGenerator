...
namespace Dapper.SqlGenerator.Async
{
    public static class QueryExtensions
    {
        ...
        /// <summary>
        /// Execute the INSERT expression on the given table
        /// RETURNING a value of the first key column defined for this table (using ExecuteScalarAsync)
        /// </summary>
        /// <typeparam name="T">The type of entity.</typeparam>
        /// <typeparam name="TReturn">Return scalar type</typeparam>
        /// <param name="connection">The connection to query on.</param>
        /// <param name="entityToInsert">The object to INSERT.</param>
        /// <param name="columnSet">Set of columns to update</param>
        /// <param name="insertKeys">If true, keys will also be inserted.</param>
        ...
        /// <param name="commandTimeout">The command timeout (in seconds).</param>
        /// <returns>Task executing INSERT returning object with inserted keys</returns>
        public static Task<TReturn> InsertReturnAsync<T, TReturn>(this IDbConnection connection, T entityToInsert, string columnSet = null, bool insertKeys = false,
            IDbTransaction transaction = null, int? commandTimeout = null)
            => connection.ExecuteScalarAsync<TReturn>(connection.Sql().InsertReturn<T>(columnSet, insertKeys), entityToInsert, transaction, commandTimeout);
